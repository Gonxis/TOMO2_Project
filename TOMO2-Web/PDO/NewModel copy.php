    ...
    <form action="?action=<?php echo $news->id_news > 0 ? 'update' : 'insert'; ?>" method="post">
        ...
        <table style="width: 500px; background: #eee; padding: 4px;">
            <tr>
                ...
                <td><input type="text" name="name" value="<?php echo $news->__GET('name'); ?>" style="width: 100%;"/>
                </td>
            </tr>
            <tr>
                <th style="text-align: left;">Description</th>
                <td><input type="text" name="description" value="<?php echo $news->__GET('description'); ?>"
                           style="width: 100%;"></textarea></td>
            </tr>
            <tr>
                <th style="text-align: left;">Upload Date</th>
                <td><input type="text" name="upload_date" value="<?php echo $news->__GET('upload_date'); ?>"
                           style="width: 100%;"/></td>
            </tr>
            <tr>
                <th style="text-align: left;">Image</th>
                <td><input type="file" name="image" value="<?php echo $news->__GET('image'); ?>" style="width: 100%;"/>
                </td>
            </tr>
            <tr>
                <th style="text-align: left;">Link</th>
                <td><input type="text" name="link" value="<?php echo $news->__GET('link'); ?>" style="width: 100%;"/>
                </td>
            </tr>
            <tr>
                <th style="text-align: left;">Active</th>
                <td><input type="text" name="active" value="<?php echo $news->__GET('active'); ?>"
                           style="width: 100%;"/></td>
            </tr>
            <tr>
                <td colspan="2">
