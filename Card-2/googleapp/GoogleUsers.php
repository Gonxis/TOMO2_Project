...
define("REDIRECT_URL", "http://localhost/TOMO2Project_Materialize/TOMO 2 Web con Materialize/index.php");
...
if ($client->exit)
  ...
  try {
    ...
    if ($result[0]["count"] > 0) {
      ...
      $sql = "INSERT INTO `GoogleLogin` (`name`, `email`) VALUES " . "( :name, :email)";
      $stmt = $DB->prepare($sql);
